<template><div><h1 id="自学指南" tabindex="-1"><a class="header-anchor" href="#自学指南"><span>自学指南</span></a></h1>
<h2 id="基本概念" tabindex="-1"><a class="header-anchor" href="#基本概念"><span>基本概念</span></a></h2>
<div class="hint-container important">
<p class="hint-container-title">重要</p>
<p>接下来我会用几句话解释一些基本概念，请你用<strong>开始</strong>一节中提到的方法搞懂你不知道的名词</p>
</div>
<ul>
<li>你正在使用的<strong>操作系统</strong> 大概率是windows，它有着标志性的四窗格logo，你的一切行为都是在这个操作系统上进行的，另一个常见的操作系统常见的操作系统是<RouteLink to="/linux.html">linux</RouteLink></li>
</ul>
<figure><img src="@source/image/guide/windows.png" alt="windows logo" width="200" height="200" tabindex="0" loading="lazy"><figcaption>windows logo</figcaption></figure>
<ul>
<li>
<p>如果你正在学习一门<strong>编程语言</strong>，那么你需要搭建好其对应的<strong>开发环境</strong>，一般是安装<strong>IDE</strong>，如果是<strong>解释型语言</strong>，那么你需要安装<strong>解释器</strong>，配置好对应的<strong>环境变量</strong></p>
</li>
<li>
<p><strong>编程语言</strong>没有层级关系，你可以挑选一门自己感兴趣的语言学习，但是最好先了解不同语言的特性，比如C++的性能更好，适用于编写高性能的程序，python的语法更简单，便于学习</p>
</li>
<li>
<p>你可以在任何地方编写<strong>源代码</strong>，包括记事本，<strong>源代码</strong>是你写的程序的原始形式，你需要通过<strong>编译器</strong>或<strong>解释器</strong>将其转换为<strong>可执行文件</strong>，然后运行；如果在<strong>IDE</strong>中，你可以直接运行，因为IDE帮你做好了这些事情</p>
</li>
<li>
<p>如果你编写了一个打印hellworld程序并运行，那么在你的桌面上会弹出一个黑色的窗口并显示‘hello world’，这个黑色的窗口就是<strong>命令行窗口</strong>，粗略地说，这个黑窗口由两部分组成，一部分是<strong>shell</strong>，一部分是<strong>terminal</strong></p>
</li>
</ul>
...
<p>不要把你的用户名设置成中文，具体来说就是C盘下的用户目录不要是中文，不然运行会出现奇怪问题；不要把文件名设置成中文，原因同上</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>如果你的用户名设置成了中文，那你最好要么重装系统，要么用管理员账户新建英文用户并链接替到中文用户，具体操作自行搜索</p>
</div>
</div>
<h3 id="ide" tabindex="-1"><a class="header-anchor" href="#ide"><span>IDE</span></a></h3>
<ul>
<li>C,C++:
<ul>
<li><a href="https://visualstudio.microsoft.com/zh-hans/" target="_blank" rel="noopener noreferrer">Visual Studio</a></li>
<li><a href="https://www.jetbrains.com/clion/" target="_blank" rel="noopener noreferrer">CLion</a></li>
</ul>
</li>
<li>python:
<ul>
...
<li>java:
<ul>
<li><a href="https://www.jetbrains.com/idea/" target="_blank" rel="noopener noreferrer">IntelliJ IDEA</a></li>
</ul>
</li>
<li>web:
<ul>
...
<li>
<p><a href="https://csdiy.wiki/" target="_blank" rel="noopener noreferrer">csdiy</a></p>
</li>
</ul>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
...
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>csdiy已经涵盖了大部分计算机方向的优质课程，可是大多优质课程都是国外的，所以你需要魔法才能访问这些课程</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
